...
var walkable = {
  ...
  BFS: function (tree, callback) {
    ...
    nodes.push(node);
    paths.push(upack.stringify(_.omit(node, 'status')));
...
Tree.prototype = {
  ...
  transform: function () {
    ...
    var transformNode = function (map, tree) {
      var semantic = upack.stringify(tree.props);
      var subMap = {};
